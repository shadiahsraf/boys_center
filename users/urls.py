...
urlpatterns = [
    ...
    path('me/', views.ProfileSelfUpdateView.as_view(), name='profile_self'),
    path('me/photo/', views.ProfilePhotoUpdateView.as_view(), name='photo_update'),
    path('me/photo/remove/', views.ProfilePhotoDeleteView.as_view(), name='photo_remove'),
